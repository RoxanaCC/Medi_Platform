...
public class PersonServiceIntegrationTests extends Ds2020TestConfig {
    ...
    public void testInsertCorrectWithGetById() {
        PersonDetailsDTO p = new PersonDetailsDTO("username", "password", "Roxi", "01.06.1997", "Cluj", "F", "patient");
        UUID insertedID = personService.insert(p);

        PersonDetailsDTO insertedPerson = new PersonDetailsDTO(insertedID, p.getUsername(), p.getPassword(), p.getName(),
                p.getBirthdate(), p.getAddress(), p.getGender(), p.getRole());
