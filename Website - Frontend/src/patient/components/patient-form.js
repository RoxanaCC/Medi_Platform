...
class PatientForm extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            formControls: {
                username: {
                    value: (this.props.action === 'add') ? '' : this.props.data.username,
                    placeholder: '...',
                ...
                password: {
                    value: (this.props.action === 'add') ? '' : this.props.data.password,
                    placeholder: '...',
                    valid: (this.props.action === 'add') ? false : true,
                    touched: false,
                    validationRules: {
                ...
                birthdate: {
                    value: (this.props.action === 'add') ? '' : this.props.data.birthdate,
                    placeholder: 'DD.MM.YYYY format',
                    valid: (this.props.action === 'add') ? false : true,
                    touched: false,
                },
                address: {
                    value: (this.props.action === 'add') ? '' : this.props.data.address,
                    placeholder: 'Cluj, Zorilor, Str. Lalelelor 21...',
                    valid: (this.props.action === 'add') ? false : true,
                    touched: false,
                },
                gender: {
                    value: (this.props.action === 'add') ? '' : this.props.data.gender,
                    placeholder: 'Male/Female/Nonbinary...',
                    valid: (this.props.action === 'add') ? false : true,
                    touched: false,
                },
                record: {
                    value: (this.props.action === 'add') ? '' : this.props.data.record,
                    placeholder: 'Covid...',
                    valid: (this.props.action === 'add') ? false : true,
                    touched: false,
                },
    ...
    handleSubmit() {
        ...
        if (this.props.action === 'add') {
            ...
            this.updatePatient(patient, this.props.data.id);
        }
        ...
        return (
            <div>
                ...
                <FormGroup id='record'>
                    ...
                    <Input name='record' id='recordField' placeholder={this.state.formControls.record.placeholder}
                           onChange={this.handleChange}
                           defaultValue={this.state.formControls.record.value}
